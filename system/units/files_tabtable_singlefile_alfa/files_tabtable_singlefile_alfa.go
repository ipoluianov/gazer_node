package files_tabtable_singlefile_alfa
...
func Info() units_common.UnitMeta {
	...
	info.TypeName = "Files.TabTable.SingleFile.Alfa"
	info.Category = "file"
...
func (c *UnitTxtTable) GetConfigMeta() string {
...
func (c *UnitTxtTable) InternalUnitStart() error {
	var err error
...
func (c *UnitTxtTable) InternalUnitStop() {
}
...
func (c *UnitTxtTable) Tick() {
	...
	for !c.Stopping {
		...
		names, values, err := ReadLastLine(c.fileName)
